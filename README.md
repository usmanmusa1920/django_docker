...
```
$ docker image tag nginx usmanmusa/nginx
```

### Upload to dockerhub

```
$ docker image push usmanmusa/nginx
```
...
```
$ docker image tag usmanmusa/dipense usmanmusa/dipense:1.0
```
...
```
$ docker image tag nginx-website:latest usmanmusa/nginx-website:latest
```

```
$ docker image push usmanmusa/dipense
```
